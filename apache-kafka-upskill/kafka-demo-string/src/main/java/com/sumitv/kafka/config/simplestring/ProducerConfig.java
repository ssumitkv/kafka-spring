...
public class ProducerConfig {
    ...
    @Bean
    @Qualifier("simpleStringProducerFactory")
    public ProducerFactory<String, String> producerFactory(){
        ...
        configProperties.put(org.apache.kafka.clients.producer.ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG, StringSerializer.class);
